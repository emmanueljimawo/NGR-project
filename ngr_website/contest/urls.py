...
from .views import Contestants, Profile, Registration, search_contestants, verify_registration_fee_payment, verify_voting_fee_payment
...
urlpatterns = [
    ...
    path('contestants/search/', csrf_exempt(search_contestants), name='contestants-search'),
